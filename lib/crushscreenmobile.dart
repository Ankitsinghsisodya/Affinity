...
class CrushMobileForm extends StatefulWidget {
  const CrushMobileForm({
    super.key,
  });

  @override
  State<CrushMobileForm> createState() => _CrushFormState();
}

class _CrushFormState extends State<CrushMobileForm> {
